...
| Métrica | Valor |
| --- | --- |
| Arquivos de texto analisados (aulas + guias) | 1016 |
| Palavras únicas no banco | 16.796 |
| Já presentes nos textos (cobertura morfológica) | 13.115 |
| **Ainda falta escrever nos textos** | **3.681** |
...
2. **Enciclopédia (Fase 2):** os dossiês temáticos pós-trilha
   (`src/data/city_guides/<cidade>_guide_<N>.json`) — 11 cidades, 525 seções,
