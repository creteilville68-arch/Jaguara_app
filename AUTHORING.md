...
| Métrica | Valor |
| --- | --- |
| Arquivos de texto analisados (aulas + guias) | 1020 |
| Palavras únicas no banco | 16.796 |
| Já presentes nos textos (cobertura morfológica) | 13.213 |
| **Ainda falta escrever nos textos** | **3.583** |
...
2. **Enciclopédia (Fase 2):** os dossiês temáticos pós-trilha
   (`src/data/city_guides/<cidade>_guide_<N>.json`) — 11 cidades, 529 seções,
